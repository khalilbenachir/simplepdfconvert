...
export function Logo({ t }: LogoProps) {
  return (
    <Link
      href="/"
      className="flex items-center gap-3 group relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-2xl"
    >
      ...
      <div className="relative">
        ...
        <div
          className="absolute -bottom-1 left-0 right-0 h-px bg-linear-to-r from-transparent via-primary/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          aria-hidden="true"
        />
      </div>
    </Link>
