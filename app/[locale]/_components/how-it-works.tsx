...
export function HowItWorks() {
  ...
  return (
    <section className="relative py-20 md:py-32 overflow-hidden bg-linear-to-b from-background via-muted/20 to-background">
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-16 md:mb-20 max-w-2xl mx-auto opacity-0 animate-fade-in-stagger">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 tracking-tight font-dm-sans">
            {t('title')}
          </h2>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-6 md:gap-8 relative">
            ...
            <div className="hidden md:block absolute top-20 left-0 right-0 z-0 px-[20%]">
        ...
        >
          ...
          >
            <Upload className="w-5 h-5 group-hover:scale-110 transition-transform duration-300" strokeWidth={2} />
